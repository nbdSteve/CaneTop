...
import gg.steve.bgbuddyboy.canetop.utils.ColorUtil;
...
public enum MessageType {
    ...
    TOP_HEADER("cane-top.header", "{page}"),
    TOP_ENTRY("cane-top.entry", "{rank}", "{player}", "{cane-mined}"),
    TOP_FOOTER("cane-top.footer", "{page}");
